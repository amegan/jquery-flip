...
this.getPrevContent(c),e=this._splitElem(g,"back"),c=this._splitElem(c,"front");-1===a?(g=c.second,e=e.first):(g=c.first,e=e.second);this.flippingElement=g;this.backFilippingElement=e;g.css("zIndex",10001);e.css("zIndex",1E4);var f=this._initShadow();this._isVertical()?(g.addClass("verticalFlipping"),e.addClass("verticalFlipping"),1===a&&f.css("top","0px")):(g.addClass("holizontalFlipping"),e.addClass("holizontalFlipping"),1===a&&f.css("left","0px"));b.append(f);g.addClass("flipping");e.addClass("backflipping");
c=b.children(".flipCurrent");c.removeClass("flipCurrent");c.addClass("working");f.show()}};l.prototype.step=function(a){if(0!==d(this.element).children(".working").length){this.currentRatio=a;var b=this.flippingElement,c=this.backFilippingElement,g=r+"Transform";b.css(g,this._calculateFlipRotateCSS(a));c.css(g,this._calculateBackFlipRotateCSS(a));g=function(a){return-1.2*(a-1)*(a-1)+1.2};d(this.element);var e=b.height(),f=0;a=Math.abs(180*a);90<a?(b.css("zIndex",1E4),c.css("zIndex",10001),"none"===
c.css("display")&&(c.css("display","block"),b.css("display","none")),this._isVertical()?-1===this.flippingSide?d(".flipShadow").css("top","0"):d(".flipShadow").css("top",e+"px"):-1===this.flippingSide?d(".flipShadow").css("left","0"):d(".flipShadow").css("left","50%"),f=Math.max(0,1-g((180-a)/90))):(b.css("zIndex",10001),c.css("zIndex",1E4),"none"===b.css("display")&&(c.css("display","none"),b.css("display","block")),this._isVertical()?-1===this.flippingSide?d(".flipShadow").css("top",e+"px"):d(".flipShadow").css("top",
"0"):-1===this.flippingSide?d(".flipShadow").css("left","50%"):d(".flipShadow").css("left","0"),f=Math.max(0,1-g(a/90)));d(".flipShadow").css("opacity",.9*f)}};l.prototype._calculateFlipRotateCSS=function(a){return this._isVertical()?"rotateX("+-180*a+"deg)":"rotateY("+180*a+"deg)"};l.prototype._calculateBackFlipRotateCSS=function(a){return this._isVertical()?1===this.flippingSide?"rotateX("+-1*(180+180*a)+"deg)":"rotateX("+(180-180*a)+"deg)":1===this.flippingSide?"rotateY("+(180+180*a)+"deg)":"rotateY("+
-1*(180-180*a)+"deg)"};l.prototype.actionBK=function(a){var b=this.currentRatio,c=this.backFilippingElement;this.flippingElement.addClass("flipAction");c.addClass("flipBackAction");this._calculateFlipRotateCSS(b);this._calculateFlipRotateCSS(a)};l.prototype.action=function(a){var b=this.currentRatio,c=this,d=0,e=Math.abs(this.currentRatio),f=Math.abs(a-this.currentRatio),k=1;0>this.currentRatio?k=-1:0===this.currentRatio&&0>a&&(k=-1);var h=function(a){a=Math.abs(a)/f;--a;return f*(a*a*a+1)+e};0===
a&&(e=0);var l=function(){d=Math.min(1,d+.05);var e=Math.min(1,h(d));0===a&&(e=Math.abs(b)-e);0>k&&(e*=-1);c.step(e);d+.05<f?setTimeout(l,20):(c.currentRatio=a,c.cleanup())};this.isInAnimation=!0;l()};l.prototype.cleanup=function(){var a=d(this.element).children(".working");d(".flipShadow").replaceWith("");d(".firstHalf").replaceWith("");d(".secondHalf").replaceWith("");var b=a;"ltor"===this.options.forwardDir&&1===this.flippingSide||"rtol"===this.options.forwardDir&&-1===this.flippingSide||"ttob"===
...
this.THREASHOLD_RATIO};h.prototype.jqmInit=function(){if(null!==d.mobile){var a=d(this.element);"undefined"!==typeof d.mobile&&d.mobile.ns&&(v=d.mobile.ns);for(var b=0,c=w.length;b<c;b++){var g=w[b],e=a.attr("data-"+v+g.attr);e&&(this.options[g.key]=1===g.type?"true"===e.toLowerCase()?!0:!1:e)}}};h.prototype.isFlipSupported=function(){if(!t.getComputedStyle)return!1;var a={webkitTransform:"-webkit-transform",MozTransform:"-moz-transform",msTransform:"-ms-transform",transform:"transform"},b=null,c=
!1,d=q.body,e;for(e in a){var f=t.getComputedStyle(d).getPropertyValue(a[e]);d.style[e]="translate3d(1px,1px,1px)";c=t.getComputedStyle(d).getPropertyValue(a[e]);d.style[e]=f;if(c){b=e;break}}if(!c)return!1;switch(b){case "webkitTransform":r="webkit";break;case "MozTransform":r="Moz";break;case "msTransform":r="ms"}return c};h.prototype._getMouseMovement=function(a,b){if(null===this._clickContext.downPt)return null;var c=a-this._clickContext.downPt.x,d=b-this._clickContext.downPt.y,c="rtol"===this.options.forwardDir||
"ltor"===this.options.forwardDir?c:d;if(null===this._clickContext.flipside)if(Math.abs(c)>this.effect.START_OFFSET)this._clickContext.flipside=0>c?-1:1,this.effect.init(this._clickContext.flipside);else return null;return c-=this.effect.START_OFFSET*(-1===this._clickContext.flipside?-1:1)};h.prototype._getClientMousePos=function(a){return null===a.clientX&&a.originalEvent?{x:a.originalEvent.clientX,y:a.originalEvent.clientY}:{x:a.clientX,y:a.clientY}};h.prototype.vmousedown=function(a){if(this._clickContext.downPt||
this.effect.isInAnimation)return!1;a=this._getClientMousePos(a);var b=(new Date).getTime();this._clickContext.downPt=a;this._clickContext.downTime=b;this._clickContext.lastInfo={x:a.x,y:a.y,time:b};this._clickContext.dList=[];this._clickContext.tList=[];return!0};h.prototype._getRatio=function(a){a/=this.effect.MAX_DISTANCE;return a=1===this._clickContext.flipside?Math.min(Math.max(0,a),1):Math.min(Math.max(-1,a),0)};h.prototype._pushMouseInfo=function(a){var b=(new Date).getTime(),c=0,c="ltor"===
this.options.forwardDir||"rtol"===this.options.forwardDir?a.x-this._clickContext.lastInfo.x:a.y-this._clickContext.lastInfo.y;if(0===c)return!1;var d=b-this._clickContext.lastInfo.time;20<this._clickContext.dList.length&&(this._clickContext.dList.shift(),this._clickContext.tList.shift());this._clickContext.dList.push(c);this._clickContext.tList.push(d);this._clickContext.lastInfo={x:a.x,y:a.y,time:b};return!0};h.prototype.vmousemove=function(a){if(null===this._clickContext.downPt||this.effect.isInAnimation)return!1;
var b=this._getClientMousePos(a),c=this._getMouseMovement(b.x,b.y);if(null===c||!this._pushMouseInfo(b))return!1;b=this._getRatio(c);this.effect.step(b);a.preventDefault();return!1};h.prototype.flipPrev=function(){if(null===this._clickContext.flipside){var a=d(this.element).children(".flipCurrent"),a=this.effect.getPrevContent(a),b=this.options.forwardDir;0<a.length&&("rtol"===b||"btot"===b?(this._clickContext.flipside=1,this.effect.init(this._clickContext.flipside),this.effect.action(1)):(this._clickContext.flipside=
-1,this.effect.init(this._clickContext.flipside),this.effect.action(-1)))}};h.prototype.flipNext=function(){if(null===this._clickContext.flipside){var a=d(this.element).children(".flipCurrent"),a=this.effect.getNextContent(a),b=this.options.forwardDir;0<a.length&&("rtol"===b||"btot"===b?(this._clickContext.flipside=-1,this.effect.init(this._clickContext.flipside),this.effect.action(-1)):(this._clickContext.flipside=1,this.effect.init(this._clickContext.flipside),this.effect.action(1)))}};h.prototype._getCleanupFunc=
function(a){var b=this,c=this.options.didEndFlip;return function(){var a=d(b.element).children(".flipCurrent").index();b.options.showPager&&b.setPagerPos(a);b._clickContext.downPt=null;b._clickContext.downTime=null;b._clickContext.flipside=null;b._clickContext.lastInfo=null;b._clickContext.dList=[];b._clickContext.aList=[];"function"===typeof c&&c(a)}};h.prototype.vmouseup=function(a){if(null===this._clickContext.downPt||this.effect.isInAnimation)return!0;var b=this._getClientMousePos(a),c=d(this.element),
b=this._getMouseMovement(b.x,b.y);if(null===b)return this._clickContext.downPt=null,this._clickContext.flipside=null,this._clickContext.downTime=null,this._clickContext.lastInfo=null,this._clickContext.dList=[],this._clickContext.aList=[],!0;var b=this._getRatio(b),g=-1===this._clickContext.flipside?-1:1,c=c.children(".working"),e=null,e=0,e=this.options.forwardDir,f=this._clickContext.flipside,e="ltor"===e&&1===f||"rtol"===e&&-1===f||"ttob"===e&&1===f||"btot"===e&&-1===f?this.effect.getNextContent(c):
this.effect.getPrevContent(c),e=this.effect.shouldTransitionContinue(b,this._clickContext)&&0<e.length?g:0;this.effect.action(e);a.preventDefault();return!0};h.prototype.initPager=function(){var a=d(this.element),b=a.height()-24+"px";a.children("div,p,section,article").each(function(a,c){d(c).css("height",b)});var c=a.children(".flipContent").length;a.append(d('<div class="pager"></div>'));for(var g=a.children(".pager"),e=0;e<c;e++)g.append(d('<span class="dot">&nbsp;</span>'));a=a.children(".flipCurrent").index();
g.children(".dot").eq(a).addClass("current")};h.prototype.setPagerPos=function(a){var b=d(this.element);b.find(".pager span.dot.current").removeClass("current");b.find(".pager span.dot").eq(a).addClass("current")};h.prototype.pagerTap=function(a){var b=d(this.element).children(".pager").width();this._getClientMousePos(a).x<b/2?this.flipPrev():this.flipNext()};h.prototype._isAccessFromMobileBrowser=function(){return navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||
navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/)?!0:!1};h.prototype.init=function(){var a=d(this.element),b=this.options.height;if(""===b){var c=a.parent().height();0===c&&(c=d(q.body).height());b=c-a.offset().top+"px"}a.addClass("flipContainer").css("height",b);a.children("div,p,section").each(function(a,c){d(c).addClass("flipContent").css("height",b)});0===a.children(".flipCurrent").length&&a.children().eq(0).addClass("flipCurrent");var g="mousedown",c="mousemove",e="mouseup";
d.mobile&&(g="vmousedown",c="vmousemove",e="vmouseup");var f=this;this._isAccessFromMobileBrowser()||a.find("img").each(function(a,b){d(b).bind(g,function(a){a.preventDefault()})});this.options.showPager&&(this.initPager(),a=a.children(".pager"),a.bind(g,function(a){a.preventDefault();return!1}),a.bind(e,function(a){f.pagerTap(a);a.preventDefault();return!1}));d(this.element).bind(g,function(a){return f.vmousedown(a)});d(this.element).bind(c,function(a){return f.vmousemove(a)});d(this.element).bind(e,
function(a){return f.vmouseup(a)});this.options.keyboardNav&&d(q).unbind("keydown.flip").bind("keydown.flip",function(a){if(!d(a.target).is("input, textarea, select, button")){var b=f.options.forwardDir;37===a.keyCode?"rtol"===b?f.flipNext():f.flipPrev():39===a.keyCode&&("rtol"===b?f.flipPrev():f.flipNext())}})};d.fn.flip=function(a){1<this.length&&(a.keyboardNav=!1);return this.each(function(){if(!d.data(this,"plugin_flip")){var b=new h(this,a);d.data(this,"plugin_flip",b)}})};d(q).bind("pageinit create",
function(a){d(':jqmData(role="flip")',a.target).flip()})})(jQuery,window,document);//# sourceMappingURL=jquery.mobile.flip.min.js.map

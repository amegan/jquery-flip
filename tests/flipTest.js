...
function test_SplitElem() {
  ...
  strictEqual($first.width(), Math.ceil(width / 2), 'RTOL: first half width is ceiled');
  ...
  Math.ceil(width / 2),
  'LTOR: first half width is ceiled');
  ...
  strictEqual($first.height(),
  Math.ceil(height / 2),
  'TTOB: first half height is ceiled');
  ...
  strictEqual($second[0].offsetTop,
    Math.ceil(height / 2),
    'TTOB: second half top positiojn is cieled. It must be same as first half height.');
    ...
    strictEqual($first.height(),
    Math.ceil(height / 2),
    'BTOT: first half height is ceiled');
    ...
    strictEqual($second[0].offsetTop,
      Math.ceil(height / 2),
      'BTOT: second half top positiojn is ceiled. It must be same as first half height.');
    ...
    function testFlipForward() {
      ...
      var startX = Math.ceil(bodyWidth * 0.8);
      var startY = Math.ceil(bodyHeight * 0.5);
      var limit = Math.ceil(bodyWidth * 0.7);
      ...
      function testFlipBackward() {
        ...
        var startX = Math.ceil(bodyWidth * 0.2);
        var startY = Math.ceil(bodyHeight * 0.5);
        var limit = Math.ceil(bodyWidth * 0.3);
